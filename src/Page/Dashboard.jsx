              ...
              <div className="flex flex-col space-y-4">
                <div className="rounded-xl border border-blue-800/40 bg-gray-900/60 backdrop-blur-md p-4 flex flex-col shadow-2xl">
                  ...
                  <div className="space-y-3 text-xs">
                    <div className="rounded-lg border border-blue-800/40 bg-blue-950/40 p-3 shadow-inner">
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-gray-300">진단 요약</span>
                        <span className="rounded bg-red-950/80 px-2 py-0.5 text-red-400 border border-red-800/60 font-medium shadow-inner">신뢰도 87%</span>
                      </div>
                      <p className="text-sm font-bold text-white">협착 의심</p>
                    </div>
                    <div className="rounded-lg border border-blue-800/40 bg-blue-950/40 p-3 shadow-inner">
                      <span className="text-gray-300 block mb-1">병변 위치</span>
                      <p className="font-medium text-blue-200">RCA 중간 부위</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-blue-800/40 bg-gray-900/60 backdrop-blur-md p-4 shrink-0 shadow-2xl">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <input type="checkbox" checked={heatmapToggle} onChange={() => setHeatmapToggle(!heatmapToggle)} className="cursor-pointer accent-blue-500" />
                  </div>
